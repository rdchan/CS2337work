...
Player::Player(std::string name, bool homeTeam) : Player(name) {
...
int Player::getPlateAppearances() const {
    ...
    return this->hits + this->outs + this->strikeouts + this->walks + this->hit_by_pitches + this->sacrifices + this->errors;
}
